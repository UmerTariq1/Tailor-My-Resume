...
prompt_publications = """
Act as an HR expert and resume writer with a specialization in creating ATS-friendly resumes. Your task is to include a section for published research papers. For each paper, ensure you include:

1. **Paper Title**: The title of the research paper.
2. **Journal/Conference Name**: The name of the journal or conference where the paper was published.
3. **Authors**: List the authors, highlighting your name in bold.
4. **Publication Date**: The date the paper was published.
5. **DOI or Link**: Include a DOI or link to the paper if available.
...
<section id="publications">
    ...
    <div class="entry">
        ...
        <p>[Journal or Conference Name], [Publication Date]</p>
        <p>Co-authors: [Co-authors]</p>
        <p><a href="[DOI or Link]">[DOI or Link]</a></p>
    </div>
    <div class="entry">
        <p><strong>[Publication Title]</strong></p>
        <p>[Journal or Conference Name], [Publication Date]</p>
