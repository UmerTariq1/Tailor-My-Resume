...
class LLMResumeJobDescription:
    ...
    def generate_publication_section(self) -> str:
        ...
        education_prompt_template = self._preprocess_template_string(
            self.strings.prompt_publications
        )
        prompt = ChatPromptTemplate.from_template(education_prompt_template)
        chain = prompt | self.llm_cheap | StrOutputParser()
        output = chain.invoke({
        ...
        print("Generated publication section")
    ...
    def generate_work_experience_section(self) -> str:
        ...
        print("Generated work experience section")
    ...
    def generate_side_projects_section(self) -> str:
        ...
        print("Generated side projects section")
    ...
    def generate_additional_skills_section(self) -> str:
        ...
        chain = prompt | self.llm_cheap | StrOutputParser()
        output = chain.invoke({
            "languages": self.resume.skills.languages,
            "frameworks": self.resume.skills.frameworks,
            "tools": self.resume.skills.tools,
            "soft_skills": self.resume.skills.soft_skills,
            "job_description": self.job_description
        })

        print("Generated additional skills section")
    ...
    def generate_html_resume(self) -> str:
        ...
        def education_fn():
            # call only if there is atleast one education detail
        ...
        def publications_fn():
            if self.resume.publications:
                return self.generate_publication_section()
            else:
                return None
        ...
        with ThreadPoolExecutor() as executor:
            ...
            for future in as_completed(future_to_section):
                ...
                # if it has returned none then skip
                try:
        ...
        full_resume = (
            f"<body>\n"
            f"  {results.get('header', '')}\n"
            f"  <main>\n"
            f"    {results.get('work_experience', '')}\n"
            f"    {results.get('publications', '')}\n"
            f"    {results.get('education', '')}\n"
            f"    {results.get('additional_skills', '')}\n"
            f"    {results.get('side_projects', '')}\n"
            f"    {results.get('achievements', '')}\n"
            f"  </main>\n"
            f"</body>"
        )
